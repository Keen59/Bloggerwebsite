      ...
      <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div id="page-wrapper" >
            ...
            <div class="kategoriekle">
                    <input style="width:50%" id="kategoriadi" class="form-control" placeholder="Kategori adini Yazınız:">
                    <br><br>
                    <button id="kategorikayit" type="submit" style="vertical-align:middle"><span>Kategori ekle</span></button>
                    <br><br>
                    <br>
             </div>
            </form>
    ...
    $("#cikis").click(function() {
        ...
        $("#kategorikayit").click(function() {
             ...
             var kategoriadi=$("#kategoriadi").val();
                ...
                $.ajax({
                    url: 'kategoriekle.php',
                    type: "POST",
                    data:{kategoriadi:kategoriadi}, 
                    success:function(){
...
{    
  include("sistem/baglan.php");
    ...
    $kategori=$_POST["kategoriadi"];
    $ekleme = $baglanti->prepare("INSERT INTO kategoriler SET kategori_adlari=?");
    $ekleme->execute(array($kategori));
