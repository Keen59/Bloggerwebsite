...
date_default_timezone_set('Europe/Istanbul');
  ...
  $icerik=$baglanti->query("select * from bloglar where onay='beklemede'");
  $icerik->execute();
...
<td><a href="#" class="onaylabutton" id="<?php echo $id; ?>" ><img src="images/check.png" width="35px" height="35px" alt=""></a> </td>
...
onay*/
  ...
  $icerik2=$baglanti->query("select * from yorumlar where onay='beklemede'");
  $icerik2->execute();
...
<td><a href="#" class="onaylabuttonyorum" id="<?php echo $yorumid; ?>" ><img src="images/check.png" width="35px" height="35px" alt=""></a> </td>
...
?>
    ...
    <script src="assets/js/custom.js"></script>
        ...
        $(".silbutton").click(function() {
            ...
            $(".onaylabuttonyorum").click(function() {
              var id = $(this).attr('id');
              var islem="onayla";
            console.log(id);
...
{    
  ...
  $islem=$_POST["islem"];
    ...
    $idm=$_POST["id"];
    $onay="onayli";
    $guncelle=$baglanti->query("UPDATE yorumlar SET onay='$onay' WHERE yorumid='$idm' ");
    }
    if($islem=="yorumsil")
    {
    $idm=$_POST["id"];
